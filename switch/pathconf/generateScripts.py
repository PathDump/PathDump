    ...
    def add_flows(self):
        ...
        for br in self.bridges:
            ...
            if br.type == "ToR":
                ...
                if pathconf_rules:
                    self.forw_inst.add6HopTorFlows(br)
                else:
                ...
                if pathconf_rules:
                    self.forw_inst.add6HopAggFlows(br) 
                else:
                ...
                if pathconf_rules:
                    self.forw_inst.add6HopCoreFlows(br)
                else:
...
if __name__ == "__main__":
    ...
    edgeInfo = topo['edges']
    if 'pathconf' in topo and topo['pathconf']:
        pathconf_rules = True
